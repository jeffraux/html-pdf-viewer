# html-pdf-viewer
Client-side rendering of html to pdf with display and save options. This is project is heavily based on [html2pdf](https://github.com/eKoopmans/html2pdf). You should check it out if you don't need the additional option of displaying the PDF onto your page.
